...
public class main extends javax.swing.JFrame {
    ...
    private void suppInfo() {
      ...
      private void displayCatCount() {
        try {
            DataBaseConnection.getInstance().ConnectToDatabase();
            String sql = "SELECT COUNT(*) AS item_count FROM addcategory";
   ...
   private void displayStockStatus() {
    ...
    private void initComponents() {
        ...
        catLabel.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        catLabel.setForeground(new java.awt.Color(255, 255, 255));
        catLabel.setText("jLabel17");
